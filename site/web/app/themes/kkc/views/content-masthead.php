...
<?php if ( is_front_page() ) : ?>
	<img class="img-responsive" src="<?php echo $url; ?>" alt="<?php echo get_bloginfo( 'name' ); ?>" title="<?php echo get_bloginfo( 'name' ); ?>">
	<h1 class="front-page-display">Helping you keep<br>the life you love</h1>
<?php endif; ?>
